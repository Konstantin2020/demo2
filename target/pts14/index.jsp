...
<c:if test="${create_DQ_bool == null}">
	<p><font size="5" color="blue" face="Arial"><a href='<c:url value="/main" />'>Инициализация сервисов (init()) и подготовка базы данных в памяти</a></font></p>
...
<c:if test="${create_DQ_bool}">
	<p><font size="5" color="#c0c0c0" face="Arial">Инициализация сервисов (init()) и подготовка базы данных в памяти</font></p>
...
<c:if test="${create_DB_bool}">
    <p><font size="4" color="green" face="Arial">База для хранения обработанных заявок создана</font></p>
			...
			<c:if test="${fileSourceName_int == null}">
				<p><font size="5" color="blue" face="Arial"><a href='<c:url value="/uploadFile" />'>Открыть файлы - источники данных</a></font></p>
			...
			<c:if test="${fileSourceName_int==2}">
				<p><font size="5" color="#c0c0c0" face="Arial">Открыть файлы - источники данных</font></p>
			    <p><font size="4" color="green" face="Arial">Архив с файлами-источниками данных выбран</font></p>
			    <p><font size="5" color="blue" face="Arial"><a href='<c:url value="/create" />'>Создать новую заявку</a></p>
			         <c:choose>
